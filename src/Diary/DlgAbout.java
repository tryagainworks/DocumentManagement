...
public class DlgAbout extends javax.swing.JDialog {
    ...
    static DlgAbout objDlg;

    public static DlgAbout self(JFrame objFrm, boolean blnModel) {
        if (objDlg == null) {
            objDlg = new DlgAbout(objFrm, blnModel);
        }
        return objDlg;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("About This Application");
